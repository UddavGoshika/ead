...
const AssignedVerifications: React.FC = () => {
    return (
        <div className={styles.container}>
            <header className={styles.header}>
                <h2 className={styles.title}>Assigned Verifications</h2>
                <p className={styles.subtitle}>Review documents for advocate background verification.</p>
            </header>
