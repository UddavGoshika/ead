...
const CallSupportDashboard: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const demoTimer = setTimeout(() => {
            if (!activeCall && !incomingCallId && callLogs.length === 1) {
                setIncomingCallId('DEMO-CALL-99');
                setIncomingCall({
                    callerName: 'Alice Johnson (Test)',
                    callerPhone: '+91 9111888444',
        ...
        return () => { unsubscribe(); clearTimeout(demoTimer); };
    ...
    const handleAnswerCall = async () => {
        ...
        if (incomingCallId === 'DEMO-CALL-99') {
            setActiveCall({
                id: incomingCallId,
                clientName: incomingCall.callerName,
                clientPhone: incomingCall.callerPhone,
                email: incomingCall.email,
                unique_id: incomingCall.unique_id,
                status: 'Connected'
            });
    ...
    return (
        <div className={styles.fullDashboardArea}>
            ...
            <div className={styles.callLogsBox}>
                <div className={styles.boxHeader}><h3>Recent Call Activity</h3></div>
