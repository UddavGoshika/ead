...
export const LIVE_CHAT_MENU: MenuItem[] = [
    {
        id: "chat-workspace",
        name: "Chat Workspace",
        icon: MdDashboard,
        path: "/live-chat/workspace",
    },
    {
        id: "active-chats",
        name: "Active Signals",
        icon: MdMessage,
        path: "/live-chat/active",
        badge: "LIVE"
    },
    {
        id: "queries",
        ...
        icon: MdEmail,
        path: "/live-chat/queries",
    },
    {
        id: "payments",
        name: "Package Audit",
        icon: MdPayments,
        path: "/live-chat/payments",
    },
    {
        id: "members",
        name: "Member Audit",
        icon: MdPeople,
        path: "/live-chat/members",
        children: [
            { id: "all-members", name: "All Members", path: "/live-chat/members/all" },
            { id: "free-members", name: "Free Members", path: "/live-chat/members/free" },
            { id: "premium-members", name: "Premium Members", path: "/live-chat/members/premium" },
            { id: "approved-members", name: "Approved Members", path: "/live-chat/members/approved" },
        ],
    }
];
...
const LiveChatSidebar: React.FC<SidebarProps> = ({ collapsed }) => {
            ...
            <div className={styles.header}>
                {!collapsed ? (
                    <>
                        ...
                        <div className={styles.logoSubtitle}>LIVE CHAT</div>
                    </>
                ) : (
